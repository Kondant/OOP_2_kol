...
public class ListenerAccount extends Account {
 ...
 //jak dodac test
  //  Kliknij prawym na klasę Playlist → Go to → Test
  //  Wybierz: JUnit 5 → zaznacz metody → IntelliJ utworzy plik w src/test/java/music/
  //  Alternatywnie: ręcznie utwórz PlaylistTest.java w folderze src/test/java/music/
